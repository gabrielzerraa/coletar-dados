...
# %%
df.to_csv('Resident_Evil_Personagens.csv', index=False)
# %%
df.to_parquet('Resident_Evil_Personagens.parquet', index=False)
# %%
df.to_pickle('Resident_Evil_Personagens.pkl')
# %